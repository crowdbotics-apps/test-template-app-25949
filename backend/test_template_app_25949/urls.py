"""test_template_app_25949 URL Configuration
...
admin.site.site_header = "test-template-app"
admin.site.site_title = "test-template-app Admin Portal"
admin.site.index_title = "test-template-app Admin"

# swagger
api_info = openapi.Info(
    title="test-template-app API",
    default_version="v1",
    description="API documentation for test-template-app App",
)
